...
<html>
    ...
    <head>
        ...
        <title>One Piece | Change password</title>
    </head>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-12 text-center">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                ...
                                <a href="change-password" class="nav-link text-muted  option option-selected">비밀번호 변경</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-9 col-sm-12">
                        <div class="container-fluid p-3 border border-dark">
                            <h6 class="m-3 text-center display-6">비밀번호 변경</h6>
                            ...
                            <form id="change-password-form" action="change-password" method="post" class="px-5">
                                ...
                                <div class="mb-3">
                                    <label for="confirm-new-password" class="form-label">비밀번호 확인</label>
