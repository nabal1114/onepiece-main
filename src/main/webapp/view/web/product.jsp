                        ...
                        <div class="ps-lg-3">
                            ...
                            <div class="mt-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <button class="btn btn-dark" onclick="addToCart()" ${requestScope.product.amount > 0 ? '' : 'disabled'}> <i class="me-1 fa fa-shopping-basket"> </i>장바구니에 추가</button>
                                    </div>
                                </div>
                            </div>
                        </div>
